...
const C_PROD4 = new Producto(18,"Heineken lata 473 ml", "./assets/cervezas/heineken_lata_473ml.jpg","cervezas", "heineken", 1000)
const C_PROD5 = new Producto(19,"Heineken lata 710 ml", "./assets/cervezas/heineken_lata_710ml.jpg", "cervezas", "heineken", 1000)
const C_PROD6 = new Producto(20,"Iguana pilsen", "./assets/cervezas/iguana_pilsen_473ml.jpg", "cervezas", "iguana", 1000)
const C_PROD7 = new Producto(21,"imperial golden lata 473 ml", "./assets/cervezas/imperial_golden_lata_473ml.jpg", "cervezas", "imperial", 1000)
const C_PROD8 = new Producto(22,"imperial golden lata 710 ml", "./assets/cervezas/imperial_golden_lata_710ml.jpg", "cervezas", "imperial", 1000)
const C_PROD9 = new Producto(23,"imperial ipa lata 473 ml", "./assets/cervezas/imperial_ipa_lata_473ml.jpg", "cervezas", "imperial", 1000)
const C_PROD10 = new Producto(24,"imperial lager lata 473 ml", "./assets/cervezas/imperial_lager_lata_473ml.jpg", "cervezas", "imperial", 1000)
const C_PROD11 = new Producto(25,"imperial lager lata 710 ml", "./assets/cervezas/imperial_lager_lata_710ml.jpg", "cervezas", "imperial", 1000)
const C_PROD12 = new Producto(26,"imperial roja lata 473 ml", "./assets/cervezas/imperial_roja_lata_473ml.jpg", "cervezas", "imperial", 1000)
//aperitivos
const A_PROD1 = new Producto(25,"cinzano rosso 1l", "./assets/aperitivos/cinzano_rosso_1l.jpg", "aperitivos", "cinzano", 1000)
const A_PROD2 = new Producto(25,"cinzano rosso 450 ml", "./assets/aperitivos/cinzano_rosso_450ml.jpg", "aperitivos", "cinzano", 1000)
const A_PROD3 = new Producto(25,"fernet branca 1 lt", "./assets/aperitivos/fernet_branca_1lt.jpg", "aperitivos", "fernet", 1000)
const A_PROD4 = new Producto(25,"fernet branca 750 ml", "./assets/aperitivos/fernet_branca_750ml.jpg", "aperitivos", "fernet", 1000)
const A_PROD5 = new Producto(25,"fernet buhero negro 700 ml", "./assets/aperitivos/fernet_buhero_negro_700ml.jpg", "aperitivos", "fernet", 1000)
const A_PROD6 = new Producto(25,"hesperidina", "./assets/aperitivos/hesperidina_1lt.jpg", "aperitivos", "hesperidina", 1000)
const A_PROD7 = new Producto(25,"martini bianco 1lt", "./assets/aperitivos/martini_bianco_1lt.jpg", "aperitivos", "martini", 1000)
const A_PROD8 = new Producto(25,"martini extra dry 950 ml", "./assets/aperitivos/martini_extra_dry_950ml.jpg", "aperitivos", "martini", 1000)
